...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  var socket = (0, _socket2.default)('http://localhost:3030/view');
	  var $body = (0, _jquery2.default)('body');
	  var $images = (0, _jquery2.default)('img');

	  var $baseStyle = (0, _jquery2.default)('<link />').attr('href', 'http://localhost:3030/app.css').attr('rel', 'stylesheet');
	  (0, _jquery2.default)('head').append($baseStyle);

	  socket.on('midi:knob 16', function (val) {
	    console.log(val, 2);
	    var rgb = HSVtoRGB(val * 2, 255, 255);
	    (0, _jquery2.default)('p, a').css({
